...
element.searchButtons.innerHTML = '';
};
...
const renderButtons = (page, numOfResults, resPerPage) => {
    ...
    element.searchButtons.insertAdjacentHTML('afterbegin', button);
};

export const displayResults = (recipes, page = 1, resPerPage = 10) => {
// rendering the results of search
    const start = (page - 1) * resPerPage;
    const end = page * resPerPage;
    recipes.slice(start, end).forEach(displaySearch);
